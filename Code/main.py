...
class Score:
    ...
    def calc_chain_score(self, sym, sym_indices, atoms):
        ...
        def complex_reaction(atom_nb_inner, atom_nb_outer):
            ...
            print(f"2 * {multiplier} * ({atom_nb_outer} - {atom_nb_inner} + 1) = {int(2 * multiplier * (
                atom_nb_outer - atom_nb_inner + 1))}")
...
if __name__ == "__main__":
    ...
    ring = Ring()
    ring.start_game()
    agent = None # TODO do this from cli? and make the ifelse know if it's a human or AI playing
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if agent:
                ...
                chosen_atom_index, chosen_midway_index, clicked_mid = agent.choose_action()
